...
const Upload : NextPage = () => {
    ...
    const [componentData, setComponentData] = useState({title: "", code: "", description: "" } as userComponent);
    ...
    function handleEditorChange() {
        if(editorRef.current) {
            setComponentData({...componentData, code: editorRef.current.getValue()});
        }
    }
    ...
    return (
        <div className="mt-5 flex justify-center flex-wrap">
            ...
            <div className="flex w-full mx-6">
                ...
                <h1 className="w-1/3 flex-initial text-center text-3xl font-bold">Upload</h1>
            ...
            <main className="flex-initial w-3/5 mt-8">
                ...
                }} value={componentData.title} className="resize-none text-gray-600  focus:outline-none w-full text-xl font-semibold" placeholder="Give your component a name"/>
                <div className="h-10 w-full bg-editor">
